          ...
          <>
            ...
            <div style={{ ...card(t), border: `1px solid ${t.amber}44`, background: `${t.amber}06` }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6 }}>
                  <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: 1.5, padding: "2px 8px", borderRadius: 3, border: `1px solid ${t.green}`, color: t.green, background: `${t.green}12`, boxShadow: `0 0 8px ${t.green}44`, animation: "comingSoonPulse 2.5s ease-in-out infinite", fontFamily: "'Courier New', monospace" }}>✦ COMING SOON</span>
            ...
            <div style={{ ...card(t), border: `1px solid ${t.green}44`, background: `${t.green}06` }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  ...
                  <div style={{ fontSize: 11, color: t.textDim, marginTop: 2 }}>Compared against 2.4M flagged images</div>
                </div>
            ...
            {gpsStripped && (
              <div style={{ padding: "14px 18px", borderRadius: 10, background: `${t.green}14`, border: `1px solid ${t.green}`, textAlign: "center" }}>
                <div style={{ fontSize: 16, color: t.green, fontWeight: 700, letterSpacing: 1 }}>✓ YOU ARE PROTECTED</div>
