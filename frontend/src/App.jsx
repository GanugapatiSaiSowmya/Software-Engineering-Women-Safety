...
const PAGE_SUBTITLES = {
  ...
  audit:
    "See what's happening with your photos online",

  takedown:
    "Take down fake content and build your case",

  sos:
    "Alert your trusted people if you need help",

  support:
    "Learn, get help, and access resources",

  profile:
    "Manage profile, analytics and security"
